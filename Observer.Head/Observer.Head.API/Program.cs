...
using Observer.Head.API.Auth;
using Observer.Head.API.Mapping;
using Observer.Head.Core.Interfaces;
using Observer.Head.Infrastructure;
...
try
{
    ...
    {
        var assembly = AppDomain.CurrentDomain.Load("Observer.Head.Core");
